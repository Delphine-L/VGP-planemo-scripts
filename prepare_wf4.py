...
def main():
    ...
    parser = argparse.ArgumentParser(
                        ...
                        usage='prepare_wf4.py  -t  <Tracking table>  -k <API Key> -g <Galaxy Instance> -s <Optional suffix>',
                        formatter_class=argparse.RawTextHelpFormatter,
                        epilog=textwrap.dedent('''
                                            Outputs: 
                                            - job_files/wf4_{assembly_id}_{suffix}.yaml: The yaml file with the job inputs and parameters.
                                            - nvocations_json/wf4_invocation_{assembly_id}_{suffix}.json:  The json file with the invocation details.
    ...
    for i,row in infos.iterrows():
        ...
        res_file="invocations_json/wf4_invocation_"+spec_id+suffix_run+".json"
        yml_file="job_files/wf4_"+spec_id+suffix_run+".yml"
        if os.path.exists("job_files/wf4_"+spec_id+suffix_run+".yml"):
        ...
        wf1_inv.save_report_pdf('reports/report_wf1_'+spec_id+suffix_run+'_'+invocation_number+'.pdf')
        list_reports.append('reports/report_wf1_'+spec_id+suffix_run+'_'+invocation_number+'.pdf')
        str_elements=""
        str_hic=""
