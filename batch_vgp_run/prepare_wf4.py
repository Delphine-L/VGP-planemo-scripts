...
def main():
    ...
    parser = argparse.ArgumentParser(
                        ...
                        usage='prepare_wf4.py  -t  <Tracking table>  -g <Galaxy Instance> -k <API Key> [OPTIONS]',
                        ...
                        epilog=textwrap.dedent('''
                                            ...
                                            - {assembly_id}/invocations_json/wf4_{assembly_id}_{suffix}.json:  The json file with the invocation details.
                                            '''))
    ...
    use_file.add_argument('-v', '--wfl_version', dest="wfl_version",  required=False,  default="0.3.13", help="Optional: Specify which version of the workflow to run. Must be compatible with the sample yaml files (default: 0.3.13)")    
    ...
    if args.from_id and args.from_file:
        ...
        if 'VGP4' not in wfl_name:
            raise SystemExit("Error: The workflow ID provided does not correspond to the Assembly-Hifi-HiC-phasing-VGP4 workflow. Please check the ID.")
