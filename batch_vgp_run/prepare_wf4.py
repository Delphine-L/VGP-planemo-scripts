...
def main():
    ...
    parser = argparse.ArgumentParser(
                        ...
                        usage='prepare_wf4.py  -t  <Tracking table>  -g <Galaxy Instance> -k <API Key>  -w <workflow directory> -v <workflow version> -s <Optional suffix>',
    ...
    parser.add_argument('-v', '--wfl_version', dest="wfl_version",  required=False,  default="0.3.12", help="Optional: Specify which version of the workflow to run. Must be compatible with the sample yaml files (default: 0.3.12)")    
